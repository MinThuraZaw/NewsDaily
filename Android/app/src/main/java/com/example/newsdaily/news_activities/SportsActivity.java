...
public class SportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.sports_news);
    ...
    void loadJSON(){
        ...
        request.getSportsNews().enqueue(new Callback<NewsModel>() {
            @Override
            ...
            public void onFailure(Call<NewsModel> call, Throwable t) {
                ...
                Toast.makeText(SportsActivity.this, "Check your connection and try again", Toast.LENGTH_SHORT).show();
