...
public class GeneralActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.general_news);
    ...
    void loadJSON(){
        ...
        request.getGeneralNews().enqueue(new Callback<NewsModel>() {
            @Override
            ...
            public void onFailure(Call<NewsModel> call, Throwable t) {
                ...
                Toast.makeText(GeneralActivity.this, "Check your connection and try again", Toast.LENGTH_SHORT).show();
