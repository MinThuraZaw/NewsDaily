...
public class EntertainmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.entertainment_news);
    ...
    void loadJSON(){
        ...
        request.getEntertainNews().enqueue(new Callback<NewsModel>() {
            @Override
            ...
            public void onFailure(Call<NewsModel> call, Throwable t) {
                ...
                Toast.makeText(EntertainmentActivity.this, "Check your connection and try again", Toast.LENGTH_SHORT).show();
