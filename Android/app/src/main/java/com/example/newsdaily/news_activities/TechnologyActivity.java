...
public class TechnologyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.technology_news);
    ...
    void loadJSON(){
        ...
        request.getTechNews().enqueue(new Callback<NewsModel>() {
            @Override
            ...
            public void onFailure(Call<NewsModel> call, Throwable t) {
                ...
                Toast.makeText(TechnologyActivity.this, "Check your connection and try again", Toast.LENGTH_SHORT).show();
