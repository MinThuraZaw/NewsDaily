...
public class ScienceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.science_news);
    ...
    void loadJSON(){
        ...
        request.getScienceNews().enqueue(new Callback<NewsModel>() {
            @Override
            ...
            public void onFailure(Call<NewsModel> call, Throwable t) {
                ...
                Toast.makeText(ScienceActivity.this, "Check your connection and try again", Toast.LENGTH_SHORT).show();
